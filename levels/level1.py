    ...
    def __init__(self, autoplay: bool, dimensions: Dimensions, number_of_players: int) -> None:
        ...
        for bx in range(
            ...
            for by in range(
                ...
                self.boxes.add(Box("./assets/game-board.png",bx, by))

    def spawn_player(self,index):
        if index == 0:
            return PlayerGroup(not self.auto_play,"./assets/player1.png", STEP_DISTANCE, STEP_DISTANCE)
        if index == 1:
            return PlayerGroup(False,"./assets/player4.png", STEP_DISTANCE*self.x_length, STEP_DISTANCE*self.y_length)
        if index == 2:
            return PlayerGroup(False,"./assets/player2.png", STEP_DISTANCE, STEP_DISTANCE*self.y_length)
        if index == 3:
            return PlayerGroup(False,"./assets/player3.png", STEP_DISTANCE*self.x_length, STEP_DISTANCE)
    ...
    def make_ground(self):
        for bx in range(
            ...
            for by in range(
                ...
                self.boxes.add(Box("./assets/game-world.png",bx, by))
